...
* [汇编语言初级教程](https://yurichev.com/writings/AL4B-EN.pdf)
* [Go 高级教程](https://github.com/chai2010/advanced-go-programming-book)
* [前端开发者手册2019版](https://frontendmasters.com/books/front-end-handbook/2019/)
* [提供中国古籍电子版](https://ctext.org/analects/wei-zheng/zhs)
...
* [新华词典 数据](https://github.com/pwxcoo/chinese-xinhua)
* [开源卡通头像生成器](https://getavataaars.com)
* [全历史](https://www.allhistory.com)
* [一个演示汉字笔画顺序的 JS 库](https://chanind.github.io/hanzi-writer/docs.html)
* [一些免费的UI设计稿 sketch 等](https://www.uistore.design)
* [有趣的图标（浏览器、猫、文件、茶杯等）React Component](https://react-kawaii.now.sh)
...
### 实用库
* [CSS样式缩写策略 Tailwind CSS](https://www.tailwindcss.cn)
...
* [一个 React 组件，按钮点击后会像粒子状消解](https://github.com/transitive-bullshit/react-particle-effect-button)
